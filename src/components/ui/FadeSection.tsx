  ...
  return (
    <div className='grid-span-1 flex justify-center items-center'>
      <div
        ...
        className={`w-80 min-h-48 p-4 xl:p-8
      ...
      >
        ...
        <div
          className={`w-full flex justify-center items-center font-bold dark:text-slate-100 drop-shadow-lg`}
        >
          <a
            href={link}
            className={`bg-red border px-8 onhover:bg-redS rounded dark:border-slate-800`}
          >
            {linkName}
          </a>
        </div>
