...
const FadeSection: FC<FadeSectionProps> = ({ heading, paragraph, delayTime, link, linkName }) => {
    ...
    <div className="grid-span-1 flex justify-center items-center">
        <div className={`w-80 min-h-48 p-2 ßtransition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'} inline-block border border-transparent hover:outline-solid dark:shadow-stone-500 hover:shadow-lg hover:drop-shadow-lg rounded-lg`}>
