  ...
  return (
    <main className='flex min-h-[calc(100vh-5rem)] flex xl:items-center justify-center'>
        ...
        <div className="h-full w-full grid grid-cols-1 xl:grid-cols-2 grid-rows-2 z-50">
          ...
          <FadeSection heading={'Django & React Web Scraper'} paragraph={'Collaborating within a large team I maintained the application developed with Python, Django, Celery, Azure Services & Docker.'} delayTime={1300} link={"https://github.com/liamasis/scrape/"} linkName={"Github"}/>
