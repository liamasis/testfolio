  ...
  return (
    <main className='h-full flex xl:h-[calc(100vh-5rem)] flex xl:items-center items-start justify-center'>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-6 h-full flex items-center z-50">
        ...
        <div className="col-start-1 col-span-1 xl:col-start-5 xl:col-span-4 h-full w-full flex-grow items-start grid grid-rows-3 xl:grid-rows-4">
          <div className="col-span-3 xl:col-span-1 xl:row-start-1 xl:row-span-1 h-full w-full flex justify-center items-center ">
          ...
          <div className="col-span-3 xl:col-span-1 xl:row-start-2 xl:row-span-2 h-full w-full flex justify-center items-center ">
...
{/*               <Paragraph className='text-left'>
          ...
          <div className="col-start-2 xl:col-span-1 row-span-1 xl:row-start-4 h-full w-full flex justify-center items-center">
